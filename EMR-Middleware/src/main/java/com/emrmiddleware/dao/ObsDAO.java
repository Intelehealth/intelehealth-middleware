...
public class ObsDAO {
  ...
  public ArrayList<ObsDTO> getObsList(String lastpulldatatime, String locationuuid, String visitUUIDs)
      throws DAOException {
    ...
    try {
      ...
      obslist = obsdmo.getObsList(lastpulldatatime, locationuuid, visitUUIDs);
