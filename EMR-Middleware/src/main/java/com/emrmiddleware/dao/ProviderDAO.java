...
public class ProviderDAO {
  ...
  public ArrayList<ProviderAttributeTypeDTO> getProviderAttributeTypeMaster(String lastpulldatatime)
      throws DAOException {

    SqlSessionFactory sessionfactory = DBconfig.getSessionFactory();
    SqlSession session = sessionfactory.openSession();
    ArrayList<ProviderAttributeTypeDTO> providerAttributeTypeList =
        new ArrayList<ProviderAttributeTypeDTO>();
    try {
  ...
  public ArrayList<ProviderAttributeDTO> getProviderAttributes(String lastpulldatatime)
      throws DAOException {
