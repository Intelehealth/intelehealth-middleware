...
public interface PatientDMO {
    ...
    @Select("SELECT distinct person.uuid as uuid,\n"
            ...
            + " LIMIT #{offset}, #{limit} ")
    ArrayList<PatientDTO> getPatients(@Param("lastchangedtime") String lastpulldatatime, @Param("locationuuid") String locationuuid, @Param("offset") int offset, @Param("limit") int limit);
    ...
    int getPatientsCount(@Param("lastchangedtime") String lastpulldatatime, @Param("locationuuid") String locationuuid);
