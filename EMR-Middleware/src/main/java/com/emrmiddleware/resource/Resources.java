...
public class Resources {
  ...
  public static final boolean DEV_MODE =
      false; // This variable is used so that certain functionalities can be enable during
  // development alone
  ...
  public static final String SERVER_ERROR =
      "Unable to process request. Please try again or Contact System Administrator";
}
