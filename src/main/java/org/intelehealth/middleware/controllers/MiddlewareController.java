 ...
 */
	...
	public class MiddlewareController {
		 ...
		 * 
		 */
		public static final Logger logger = LoggerFactory.getLogger(MiddlewareController.class);
		...
		public Object pushdata(  @RequestHeader Map<String, String> headers,@RequestBody DataTraveller dataTraveller) {
			...
			if(!authUtil.validate(headers.get("authorization")) || headers.get("authorization") == null) {
				...
				pushService.returnData(dataTraveller, headers.get("authorization") );
			...
			//logger.debug(" "+ authUtil.validate(headers.get("authorization")));
